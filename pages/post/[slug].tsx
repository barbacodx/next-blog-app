...
const Post = ({ post }: Props) => {
  ...
  const onSubmit: SubmitHandler<IFormInput> = async (data) => {
    console.log(data);
    //send post data comment to sanity
    //api createComment
      ...
      <div>
        ...
        {submitted ? (
          ...
          >
            ...
            <input
              type="submit"
              className="focus:shadow-outline cursor-pointer rounded bg-blue-500  px-4 py-2 font-bold text-white shadow hover:bg-blue-400"
            />
          </form>
        )}
